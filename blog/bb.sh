...
# Modified, obviously, for the obvious author in this website.  No email nor name provided.  Have nice day.
...
global_variables() {
    ...
    global_analytics=""
    global_analytics_file="../gtag.html"
    ...
    template_read_more="Read Some More"
    ...
    template_subscribe_browser_button="Subscribe To RSS Feed"
...
create_html_page() {
    ...
    {
        cat ".header.html"
#        echo "<title>ʙʌʇʇɩɛʞʁʊɪʐɛʀ</title>"
        echo "<title>ᴛʜᴇ8ᴡᴏᴏᴅᴄᴜᴛᴛᴇʀ.ꜱʜ</title>"
#        google_analytics
        ...
        # body divs
#        echo '<!-- Google Tag Manager (noscript) --><noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MW9PQDX" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript><!-- End Google Tag Manager (noscript) -->'
...
create_includes() {
    ...
    if [[ -f $header_file ]]; then cp "$header_file" .header.html
        ...
        echo '<meta name="title" content="The Woodcutters Computing Blog" />'
        echo '<meta name="description" content= "The Woodcutters personal site and blog dedicated to Linux, computing and cool stuff!  Interesting web design and web content." />'
        echo '<meta name="robots" content= "index, follow" />'
        echo '<meta name="keywords" content="the8woodcutter, linux blog, tech blog, shell, computing, cool blog, custom design, web development" />'
        echo '<meta name="author" content="chunk@battlecruiser.co" />'
        echo '<meta property="og:title" content="ᴛʜᴇ8ᴡᴏᴏᴅᴄᴜᴛᴛᴇʀ.ꜱʜ" />'
        echo '<meta property="og:image" content="/img/og-meta-img.jpg" />'
        echo '<meta property="og:url" content="https://the8woodcutter.sh/blog" />'
        echo '<meta property="og:image:width" content="900px" />'
        echo '<meta property="og:description" content="The Woodcutters personal site dedicated to Linux, computing and stuff!" />'
